<br>
<p align="center">
  <h2 align="center">Prank XP - Someone 15/11/23</h2>
  <p align="center">
    <br>
    <br>
  </p>
...
_Projet qui a demandé beaucoup de recherche pour le support de disque NVME et des technologies AHCI qui ont évolué._

Ce projet est un projet de rétro installation.
Le projet est possible grâce à 3 outils principaux et des drivers/mises à jours :
* [Acronis True Image](/Nghy_15-11-23/Launch.cmd) (ou autre logiciel de clonage/backup de disque complet)
* [VMWare Workstation](/Nghy_15-11-23/Esc.cmd) (ou autre logiciel de virtualisation permettant de changer le type de BIOS et de plug une clé USB)
* [Windows XP Pro x64 édition](/Nghy_15-11-23/Esc.cmd.lmk) (Aucune autre édition d'XP n'est supportée, Windows Server 2003 est théoriquement mieux supporté mais non testé par notre équipe à l'heure actuelle)
...
* ISO de Windows XP Pro x64 édition (Disponible sur [Archive.org](https://archive.org/))
* Clé/Stockage USB (amorçage de Acronis True Image et stockage du backup de Windows XP Pro x64 édition)
...
* La mise à jour KB932755 correspondant à la localisation de votre Windows XP Pro x64 édition (FR et EN disponible dans le projet)
* Le driver NVME créé par [qqn](lien)
* Le driver AHCI créé par [qqn](lien)
* Un ordinateur ou ordinateur portable dont le BIOS est compatible Legacy (BIOS / CSM) et UEFI
